...
export default function AdminForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Sending password reset request for:", cleanNumber);
      
      const response = await requestPasswordResetOtp({ phoneNumber: cleanNumber });

      if (response.success) {
        setSuccess(true);
        // Store phone number in session storage for next step
        sessionStorage.setItem("resetPhoneNumber", cleanNumber);
