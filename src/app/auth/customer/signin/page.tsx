  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.data?.requiresOTP || err.requiresOTP) {
        ...
        router.push(`/auth/customer/verify-otp?email=${encodeURIComponent(userEmail)}&otpSent=true`);
        return;
      }
      ...
      if (
        ...
        router.push(`/auth/customer/verify-otp?email=${encodeURIComponent(email)}&otpSent=true`);
        return;
      }
