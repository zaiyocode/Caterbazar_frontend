        ...
        <div className="flex flex-wrap gap-2">
          ...
          {[5, 4, 3, 2, 1].map((rating) => (
            <button
              ...
              className={`cursor-pointer px-4 py-2 rounded-lg text-sm font-medium transition-colors inline-flex items-center gap-1 ${
            ...
            <div key={review._id} className="bg-white rounded-xl p-4 sm:p-6 border border-gray-200">
              ...
              <div className="flex items-start justify-between gap-4 mb-4">
                ...
                <button
                  ...
                  className={`cursor-pointer px-4 sm:px-6 py-2 rounded-lg transition-colors text-sm sm:text-base font-medium shrink-0 inline-flex items-center gap-2 ${
