...
interface AdminVendorBusinessDetailsProps {
  vendorId: string;
  isOpen: boolean;
  onClose: () => void;
}
...
export default function AdminVendorBusinessDetails({
  vendorId,
  isOpen,
  onClose,
}: AdminVendorBusinessDetailsProps) {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full sm:w-[90%] md:w-[85%] bg-white shadow-2xl z-50 overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-linear-to-r from-blue-500 to-blue-600 text-white p-6 flex items-center justify-between border-b">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold">Vendor Business Details</h1>
            <p className="text-sm text-blue-100 mt-1">Manage vendor catering business information</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="p-4 sm:p-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm sm:text-base border-gray-300"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm sm:text-base resize-none"
                    rows={3}
                  />
                </div>
              </div>
            ...
            <div className="flex gap-4 pt-6 border-t border-gray-200">
              ...
              <button
                type="submit"
                disabled={saving}
                className="flex-1 px-4 py-2 bg-linear-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:opacity-90 disabled:opacity-50 transition flex items-center justify-center gap-2 text-sm sm:text-base font-semibold"
              >
                {saving ? (
                  <>
