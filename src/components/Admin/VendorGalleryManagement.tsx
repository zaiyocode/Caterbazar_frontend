...
interface AdminVendorGalleryManagementProps {
  vendorId: string;
  isOpen: boolean;
  onClose: () => void;
}
...
export default function AdminVendorGalleryManagement({
  vendorId,
  isOpen,
  onClose,
}: AdminVendorGalleryManagementProps) {
    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full sm:w-[90%] md:w-[85%] bg-white shadow-2xl z-50 overflow-y-auto">
        ...
        <div className="sticky top-0 bg-linear-to-r from-blue-500 to-blue-600 text-white p-6 flex items-center justify-between border-b">
          <h2 className="text-lg sm:text-xl font-bold">Manage Vendor Gallery</h2>
          <button
            onClick={onClose}
